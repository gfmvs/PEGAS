...
(
	...
	LEXICON("time", 150, "type", "throttle", "throttle", 0.5),
	LEXICON("time", 152, "type", "stage", "message", "PLF Jettison"),
	LEXICON("time", 153, "type", "stage", "message", "FLR Jettison")
).
GLOBAL controls IS LEXICON
(
	"launchTimeAdvance", 180,
	"verticalAscentTime", 8,	//	7 seconds work well for 5t payload, 8 good for 15t
	"pitchOverAngle", 12.0,
	"upfgActivation", 158
).
GLOBAL vehicleinfo IS LEXICON
(
	"launchVehicleName", "Atlas-V 531",
	"vehicleInitialMass", 483810
).
