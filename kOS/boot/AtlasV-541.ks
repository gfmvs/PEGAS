...
(
	...
	LEXICON("time", 145, "type", "throttle", "throttle", 0.5),
	LEXICON("time", 147, "type", "stage", "message", "PLF Jettison"),
	LEXICON("time", 148, "type", "stage", "message", "FLR Jettison")
).
