...
(
	...
	LEXICON("time", 123, "type", "stage", "message", "SRB Jettison"),
	LEXICON("time", 275, "type", "jettison", "message", "PLF jettison", "massLost", 2206.8)
).
GLOBAL controls IS LEXICON
(
	"launchTimeAdvance", 240,
	"verticalAscentTime", 15,	//	7 seconds work well for 5t payload, 8 good for 15t
	"pitchOverAngle", 7,
	"upfgActivation", 200
).
GLOBAL vehicleinfo IS LEXICON
(
	"launchVehicleName", "Delta-IV Medium+4.2",
	"vehicleInitialMass", 330868
).
