...
(
	...
	LEXICON("time", 149, "type", "action", "message", "MECO", "actionGroup", "1"),
	LEXICON("time", 151, "type", "stage", "message", "Stage I Separation"),
	LEXICON("time", 185, "type", "stage", "message", "PLF jettison", "massLost", 3410.6)
).
GLOBAL controls IS LEXICON
(
	"launchTimeAdvance", 140,
	"verticalAscentTime", 17,
	"pitchOverAngle", 5.0,
	"upfgActivation", 156
).
GLOBAL vehicleinfo IS LEXICON
(
	"launchVehicleName", "Falcon-9 Reusable (Drone Ship)",
