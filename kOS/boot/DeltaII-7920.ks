...
(
	...
	LEXICON("time", 78, "type", "stage", "message", "Jettison Ground Ignite SRB "),
	LEXICON("time", 156, "type", "stage", "message", "Jettison Air-start SRB"),
...
(
	"launchVehicleName", "Delta-II 7920",
	"vehicleInitialMass", 236083
).
