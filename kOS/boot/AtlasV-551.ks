...
(
	...
	LEXICON("time", 15, "type", "throttle", "throttle", 0.6),
	LEXICON("time", 50, "type", "throttle", "throttle", 1.0),
	LEXICON("time", 94, "type", "stage", "message", "SRB Jettison"),
	LEXICON("time", 140, "type", "throttle", "throttle", 0.5),
	LEXICON("time", 142, "type", "stage", "message", "PLF Jettison"),
	LEXICON("time", 143, "type", "stage", "message", "FLR Jettison")
).
...
(
	"launchVehicleName", "Atlas-V 551",
	"vehicleInitialMass", 577240
).
