...
(
	...
	LEXICON("time", 252, "type", "stage", "message", "PLF jettison", "massLost", 2127)
).
GLOBAL controls IS LEXICON
(
	"launchTimeAdvance", 180,
	"verticalAscentTime", 38,	//	7 seconds work well for 5t payload, 8 good for 15t
	"pitchOverAngle", 7.0,
	"upfgActivation", 190
).
GLOBAL vehicleinfo IS LEXICON
(
	"launchVehicleName", "Atlas-V 401",
	"vehicleInitialMass", 337815,
